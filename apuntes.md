...
2. Commit Video 198:
    + $ git add .
    + $ git commit -m "2/2 - Creando nuevos posts"
    + $ git push -u origin main
...
1. Modificar componente **client\src\components\Web\Blog\PostsListWeb\PostsListWeb.js**:
    ```js
    import { useState, useEffect } from "react"
    import { Spin, List, notification } from "antd"
    import 'antd/dist/antd.css'
    ...
    ```
2. Modificar archivo de estilo **client\src\components\Web\Blog\PostsListWeb\PostsListWeb.scss**:
    ```scss
    @import "../../../../scss/index.scss";
...
3. Commit Video 202:
    + $ git add .
    + $ git commit -m "2/2 - Mostrando el listado de todos los posts"
    + $ git push -u origin main
